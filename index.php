...
<html lang="en">
    <head>
        ...
        <title>IDEAL LAWYER-Admin Panel</title>
    ...
    <body>
		...
		<nav class="navbar navbar-inverse">
			  <div class="container-fluid">
                <a class="navbar-brand" href="index.php"><i class="icofont-blood-drop"></i>Ideal Lawyer</a>
				</div>

				<ul class="nav navbar-nav navbar-left">
				  <li><a href="userlog/userlogin.php" ><span class="glyphicon glyphicon-user" style="color:yellow;"></span> User Login</a></li>
				</ul>
			  </div>
		</nav>
                        ...
                        <div class="panel-body">
                            <form role="form">
                                <fieldset>
                                    ...
                                    <div class="checkbox">
                                        <label>
                                            <input name="remember" type="checkbox" value="Remember Me">Remember My Login
                                        </label>
                                    </div>
